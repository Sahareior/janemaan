...
const data = [
  {
    key: 1,
    image:
      "https://images.unsplash.com/photo-1751076547556-f816d884e972?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    ...
    },
    {
      ...
      render: (_, record) => (
        <Space size="middle">
          ...
          />
          <DeleteOutlined
            onClick={() => handleDelete(record)} // Pass `record` if needed
