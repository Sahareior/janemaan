...
<div className='p-5'>
      ...
      <h2 className="text-[25px] popmed font-semibold mb-6">Hunt Details</h2>

 <div className='grid grid-cols-4 p-7 justify-items-center gap-y-12'>

       <div className='flex gap-3 items-center '>
        <img className='h-[45px] w-[45px]' src="https://images.unsplash.com/photo-1751076547556-f816d884e972?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
        <div>
...
<Button className='bg-[#030712] text-[17px] popreg w-[198px] h-[50px] text-white flex items-center justify-between px-4'>
  Total clues  
  <span className='bg-[#2C739E] text-white w-7 h-7 rounded-full flex items-center justify-center text-sm'>
    ...
    <Button onClick={()=> setIsModalOpen(true)} className='bg-[#5D87A3] text-[17px] popreg w-[198px] h-[50px]'>
...
<div className='mt-7'>
<h3 className='text-[25px] font-semibold text-white pt-7 px-6 '>All Clues</h3>
    <ClueTable />
</div>
