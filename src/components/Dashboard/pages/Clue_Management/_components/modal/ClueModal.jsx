...
<div>
  {
    edit?         <div>
          ...
          <p className="text-gray-400 popreg text-sm sm:text-base">Edit a clue for participants</p>
        </div> :        <div>
          <h2 className="text-white popmed text-lg sm:text-xl md:text-2xl font-bold">
            Create New Clue
          </h2>
...
{
  edit?             <div className="flex flex-col mt-6 gap-8">

        {/* City + Description + Map */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex flex-col justify-between">
            <div>
              <label htmlFor="city" className="text-white block mb-1 popmed text-sm sm:text-base">Edit Clue Name</label>
              <Input
                id="city"
            ...
            <div>
              <label htmlFor="desc1" className="text-white block mb-1 popmed text-sm sm:text-base">Edit Riddle or Puzzle</label>
              <TextArea
                id="desc1"
          ...
          <div>
            <label className="text-white block mb-2 font-medium text-sm sm:text-base"> Edit Location</label>
        ...
        <div className="space-y-5">
          <h3 className="text-lg sm:text-xl font-semibold text-white">Edit QR Code Details</h3>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-6">
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="w-full">
                  <label htmlFor="lat" className="text-white block mb-1 popreg text-sm sm:text-base">Edit Latitude</label>
                  <Input
                    id="lat"
                    placeholder="40.7128"
                ...
                <div className="w-full">
                  <label htmlFor="long" className="text-white block mb-1 popreg text-sm sm:text-base">Edit Longitude</label>
                  <Input
                    id="long"
                    placeholder="-74.0060"
                    className='placeholder-[#9E9E9E]'
              ...
              <div className="space-y-4">
                <div>
                  <label htmlFor="id" className="text-white block mb-1 popreg text-sm sm:text-base">Edit Clue ID</label>
                  <Input
                    id="id"
                    className='placeholder-[#9E9E9E]'
                ...
                <div>
                  <label htmlFor="expiry" className="text-white block mb-1 popreg text-sm sm:text-base">Edit Expires On</label>
                  <Input
                    id="expiry"
                    className='placeholder-[#9E9E9E]'
            ...
            <div>
              <label htmlFor="desc2" className="text-white block mb-2 popmed text-sm sm:text-base">Edit Hints</label>
              <TextArea
                id="desc2"
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 mt-6">
                <Button onClick={()=> handleCreate()} className="bg-[#2C739E] text-white w-full sm:w-[135px] h-[50px]">Edit Clue</Button>
                <Button onClick={()=> handleCancel()} className="w-full sm:w-[135px] h-[50px] bg-black text-white">Cancel</Button>
              </div>
            </div>
          </div>
        </div>

      </div> :            <div className="flex flex-col mt-6 gap-8">
