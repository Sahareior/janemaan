...
const StatCard = ({ title, value }) => (
  <div className="w-full h-[115px] flex justify-center items-center bg-[#1E1E1E] border border-[#5D87A3] rounded-[12.76px] p-4">
    <div>
      <h3 className="text-[19px] text-[#9E9E9E]">{title}</h3>
      <h4 className="text-[29px] text-white font-bold">{value}</h4>
    </div>
  </div>
);
...
const Overview = () => {
  return (
    <div className="px-5 md:px-10 lg:px-20 py-10 space-y-12">
      {/* Stats Cards */}
